...
import bulletHoleImg from "../public/img/bullet-hole.png";
    ...
    <>
        ...
        <div className="flex items-center w-full lg:w-1/2 pt-6">
          <div className="max-w-2xl mb-8">
            <h1 className="font-blackops text-4xl font-bold leading-snug tracking-wide lg:text-4xl lg:leading-tight xl:text-6xl xl:leading-tight text-white relative z-10">
              ...
              <div className="hidden md:flex absolute opacity-60 -top-32 -left-28 -z-10">
                <Image
                    className=""
                    src={bulletHoleImg}
                    width="200"
            ...
            <p className=" py-5 text-lg tracking-wide leading-normal lg:text-xl xl:text-2xl text-gray-300">
            ...
            <div className="flex flex-col items-start space-y-3 sm:space-x-4 sm:space-y-0 sm:items-center sm:flex-row">
              <a
                ...
                target="_blank"
                rel="noopener"
                className="font-blackops px-8 py-4 text-xl font-medium text-center text-white bg-red-700 hover:bg-red-900 rounded-md ">
                Ver más
              </a>
              <a
                ...
                <svg className="w-5 h-5" viewBox="0 0 256 268" version="1.1" xmlns="http://www.w3.org/2000/svg" xlink="http://www.w3.org/1999/xlink" preserveAspectRatio="xMidYMid">
                  <g>
        ...
        <div className="flex items-center justify-center w-full lg:w-1/2">
          <div className="relative">
            <Image
              ...
              placeholder="blur"
            />
            <div className="absolute bottom-0 z-10 flex h-2 w-full items-center justify-center overflow-hidden text-center backdrop-blur-sm"></div>
          </div>
        </div>
      </Container>
      <br></br>
      <Container>
        <div className="flex flex-col justify-center">
          <div className="text-xl text-center text-white font-blackops">
